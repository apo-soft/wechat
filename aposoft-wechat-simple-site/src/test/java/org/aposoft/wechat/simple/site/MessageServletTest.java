...
public class MessageServletTest {
    ...
    final String messageContent = "<xml><ToUserName><![CDATA[gh_0f504b63df22]]></ToUserName>"
            + "<FromUserName><![CDATA[ojqOLxLh0480oz5gqHqLgzRgCLHM]]></FromUserName>" + "<CreateTime>1476523223</CreateTime>"
            + "<MsgType><![CDATA[text]]></MsgType>" + "<Content><![CDATA[我]]></Content>" + "<MsgId>6341618955014860869</MsgId>" + "</xml>";
    ...
    public void testReceiveAndAutoReply() throws RemoteException {
        ...
        StringEntity entity = new StringEntity(messageContent, ContentType.create("text/xml", Lexical.UTF8_CHARSET));
